    ...
    <header className="sticky top-0 z-40 border-b border-border bg-card">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          {isAdmin && (
            <Link
              href="/admin"
              className="flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition-colors cursor-pointer bg-primary/5 text-primary border border-primary/20 hover:bg-primary/10"
            >
      ...
      <nav className="flex items-center gap-1 overflow-x-auto border-t border-border px-4 py-2 md:hidden">
        ...
        {isAdmin && (
          <Link
            href="/admin"
            className="flex items-center gap-1.5 whitespace-nowrap rounded-md px-3 py-1.5 text-xs font-medium transition-colors cursor-pointer bg-primary/5 text-primary border border-primary/20"
          >
